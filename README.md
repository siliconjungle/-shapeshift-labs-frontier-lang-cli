...
Command line interface for parsing, checking, hashing, and emitting Frontier Lang projects.
...
These are Frontier-only package measurements for @shapeshift-labs/frontier-lang-cli. They exercise the package's own parser, checker, compiler, projection, CLI, fuzz, or semantic-kernel surface without making competitor comparison claims.
